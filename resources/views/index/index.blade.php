...
<div class="head-top">
     ...
     <ul class="reg-login-click">
      <li><a href="index/login/login">登录</a></li>
      <li><a href="index/login/register" class="rlbg">注册</a></li>
      <div class="clearfix"></div>
     </ul><!--reg-login-click/-->
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{asset('index/goods/proinfo')}}/{{$v->goods_id}}"><img src="{{config('app.img_url')}}{{$v->goods_img}}"/></a></dt>
